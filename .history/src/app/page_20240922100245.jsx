      ...
      <div className="w-full px-12">
        ...
        <div className="w-full py-5">
          ...
          <div className="py-3 grid grid-cols-1 lg:grid-cols-5 gap-5 lg:gap-8">
            ...
            {/* Right Section */}
            <div className="lg:col-span-2 grid grid-cols-5 lg:flex lg:flex-col gap-3 items-start">
              <div className="col-span-2 rounded-[10px] overflow-hidden text-white">
              ...
              <div className="col-span-4 rounded-[10px] border border-gray-300 ">
                <div className="p-3 flex justify-between items-center">
                  <p className="text-lg font-medium text-[#161E54]">
                    Upcomming Schedule
                  </p>
                ...
                <div className="max-h-[185px] p-3 flex flex-col gap-3 overflow-hidden">
