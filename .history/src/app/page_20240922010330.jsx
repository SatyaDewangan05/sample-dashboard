      ...
      <div className="w-full px-12">
        ...
        <div className="w-full py-5">
          ...
          <div className="grid grid-cols-5 gap-5">
            <div className="col-span-3 py-3 flex flex-col gap-3">
            ...
            <div>
              <div className="rounded-[10px] text-white">
                <p className="bg-[#1B204A]">Recent Activity</p>
                <div className="bg-[#161E54]"></div>
              </div>
            </div>
          </div>
        </div>
